...
В принципе работает довольно стабильно с моим домашним роутером, единственное, что я заметил по возможности отключать bluetooth если в нем нет надобности! Даже если ваш router работает на 5Ghz ! заметил что отключение при отключенном bluetooth подключение по wi-fi работает значительно стабильнее и немного быстрее. 
